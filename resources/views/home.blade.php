                    ...
                    <div class="card-body">
                        <table id="productsTable" class="table table-hover table-product" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-01.jpg')}}" alt="Product Image">
                                    </td>
                                    <td>Coach Swagger</td>
                                    <td>24541</td>
                                    <td>27</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-02.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-03.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-04.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-05.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-06.jpg')}}" alt="Product Image">
                                    </td>
                                    <td>Olay</td>
                                    <td>24546</td>
                                    <td>19</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-07.jpg')}}" alt="Product Image">
                                    </td>
                                    <td>Ledger Nano X</td>
                                    <td>24547</td>
                                    <td>61</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-08.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-09.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-10.jpg')}}" alt="Product Image">
                                    </td>
                                    <td>Wattbike Atom</td>
                                    <td>24550</td>
                                    <td>61</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-11.jpg')}}" alt="Product Image">
                                    </td>
                                    <td>Smart Watch</td>
                                    <td>24551</td>
                                    <td>19</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-12.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-13.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-14.jpg')}}" alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/images/products/products-xs-15.jpg')}}" alt="Product Image">
                                    </td>
                                    <td>Headphones</td>
                                    <td>24555</td>
                                    <td>17</td>
                ...
                <div class="card card-default chat">
                    ...
                    <div class="card-body pb-0" data-simplebar style="height: 363px;">
                        <div class="media media-chat">
                            <img src="{{ asset('assets/images/user/user-sm-01.jpg')}}" class="rounded-circle" alt="Avata Image">
                        ...
                        <div class="media media-chat media-chat-right">
                            ...
                            <img src="{{ asset('assets/images/user/user-sm-02.jpg')}}" class="rounded-circle" alt="Avata Image">
                        </div>
                        <div class="media media-chat">
                            <img src="{{ asset('assets/images/user/user-sm-01.jpg')}}" class="rounded-circle" alt="Avata Image">
                            <div class="media-body">
